...
/*	public SerialPort()
	...
	public int OpenSerialPort(String port)
	{
		if(fd >= 0)
		{
			close(fd);
	...
	public String ReadSerialString(int fd, int len,int delay) throws UnsupportedEncodingException{
		byte[] tmp;
		tmp = readport(fd,len,delay);
		if(tmp == null)
		{
