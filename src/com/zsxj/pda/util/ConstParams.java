...
public class ConstParams {
	...
	public static class Interface {
		...
		private static final String GDYX_IP = QIQU_IP;
		...
		public static final String getPrefix(String sellerNick) {
			...
			} else if (sellerNick.equals("gdyx")) {
				prefix = "http://" + GDYX_IP + "/stockapi/interface.php";
			}
			return prefix;
		}
		...
		public static final String INTERFACE_ID = "InterfaceID=pda&";
		...
		public static final String GDYX_KEY = "36beddec11eee8842a8df519f626df8a";
