...
@SuppressLint("NewApi") public class PdDetailsActivity extends ListActivity implements QueryCallBack, 
	UpdateCallBack {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Log.d("Scan Process", "PdDetailsActivity, onKeyDown");
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		Log.d("Scan Process", "PdDetailsActivity, onKeyUp");
		if (KeyEvent.KEYCODE_F2 == keyCode) {
			if (mKeepLoading)
				return true;
			Log.d("Process", "FastPdListActivity, xiuxi");
			Globals.setIsScanning(false);
		}
