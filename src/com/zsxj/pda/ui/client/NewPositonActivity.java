...
public class NewPositonActivity extends ActionBarActivity implements UpdateCallBack{
...
//				from, to, 0);
		mAdapter = new SimpleCursorAdapter(this, R.layout.simple_list_item_1, null, from, to);
