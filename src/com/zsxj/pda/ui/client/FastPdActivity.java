...
public class FastPdActivity extends ActionBarActivity implements UpdateCallBack {
	...
	protected void onPause() {
		Log.d("Process", "FastPdActivity, onPause");
		super.onPause();
	}
	
	@Override
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Log.d("Process", "FastPdActivity, onKeyDown");
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		Log.d("Process", "FastPdActivity, onKeyUp");
		if (KeyEvent.KEYCODE_F2 == keyCode) {
		}
