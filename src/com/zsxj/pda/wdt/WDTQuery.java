...
import com.zsxj.pda.ui.client.Student;
...
public class WDTQuery {
	...
	public native byte[] test(Student s[]);
	...
	private native byte[] preGetInterfaceWarehouses() throws WDTException;
	...
	public void queryInterfaceWarehouses(Context context, QueryCallBack callback) {
    	Params params = new Params();
		...
		public void run() {
			...
			try {
				...
				if (TYPE_WAREHOUSES == mParams.type) {
			    	...
			    	bytes1 = preGetInterfaceWarehouses();
